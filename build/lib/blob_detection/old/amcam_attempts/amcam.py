...
class Amcam:
    ...
    def __convertModel(a):
        t = AmcamModelV2(__class__.__convertStr(a.name), a.flag, a.maxspeed, a.preview, a.still, a.maxfanspeed,
                         a.ioctrol, a.xpixsz, a.ypixsz, __class__.__convertResolution(a))
        return t

    @staticmethod
    def __convertDevice(a):
        return AmcamDeviceV2(__class__.__convertStr(a.displayname), __class__.__convertStr(a.id),
                             __class__.__convertModel(a.model.contents))
    ...
    def PullImageV2(self, pImageData, bits, pInfo):
        if pInfo is None:
            ...
            x = __FrameInfoV2()
            self.__lib.Amcam_PullImageV2(self.__h, pImageData, bits, byref(x))
    ...
    def PullStillImageV2(self, pImageData, bits, pInfo):
        if pInfo is None:
            ...
            x = __FrameInfoV2()
            self.__lib.Amcam_PullStillImageV2(self.__h, pImageData, bits, byref(x))
            self.__convertFrameInfo(pInfo, x)
    ...
    def PullImageWithRowPitchV2(self, pImageData, bits, rowPitch, pInfo):
        if pInfo is None:
            ...
            x = __FrameInfoV2()
            self.__lib.Amcam_PullImageWithRowPitchV2(self.__h, pImageData, bits, rowPitch, byref(x))
            self.__convertFrameInfo(pInfo, x)
    ...
    def get_ResolutionRatio(self, nResolutionIndex):
        x = ctypes.c_int(0)
        y = ctypes.c_int(0)
        self.__lib.Amcam_get_ResolutionRatio(self.__h, ctypes.c_uint(nResolutionIndex), ctypes.byref(x),
                                             ctypes.byref(y))
        return (x.value, y.value)
    ...
    def get_StillResolution(self, nResolutionIndex):
        x = ctypes.c_int(0)
        y = ctypes.c_int(0)
        self.__lib.Amcam_get_StillResolution(self.__h, ctypes.c_uint(nResolutionIndex), ctypes.byref(x),
                                             ctypes.byref(y))
        return (x.value, y.value)
    ...
    def put_LEDState(self, iLed, iState, iPeriod):
        self.__lib.Amcam_put_LEDState(self.__h, ctypes.c_ushort(iLed), ctypes.c_ushort(iState),
                                      ctypes.c_ushort(iPeriod))
    ...
    def put_Roi(self, xOffset, yOffset, xWidth, yHeight):
        self.__lib.Amcam_put_Roi(self.__h, ctypes.c_uint(xOffset), ctypes.c_uint(yOffset), ctypes.c_uint(xWidth),
                                 ctypes.c_uint(yHeight))
    ...
    def IoControl(self, index, eType, outVal):
        x = ctypes.c_int(0)
        self.__lib.Amcam_IoControl(self.__h, ctypes.c_uint(index), ctypes.c_uint(eType), ctypes.c_int(outVal),
                                   ctypes.byref(x))
        return x.value
    ...
    def get_AfParam(self):
        ...
        return AmcamAfParam(x.imax.value, x.imin.value, x.idef.value, x.imaxabs.value, x.iminabs.value, x.zoneh.value,
                            x.zonev.value)
    ...
    def Update(cls, camId, filePath, pFun):
        ...
        if sys.platform == 'win32':
            ...
            return cls.__lib.Amcam_Update(camId.encode('ascii'), filePath.encode('ascii'),
                                          cls.__PROGRESS_CALLBACK(cls.__progressCallbackFun), None)
    ...
    def __initlib(cls):
        if cls.__lib is None:
            ...
            if sys.platform == 'win32':
                ...
                cls.__lib.Amcam_Update.argtypes = [ctypes.c_wchar_p, ctypes.c_wchar_p, cls.__PROGRESS_CALLBACK,
                                                   ctypes.py_object]
            else:
                ...
                cls.__lib.Amcam_Update.argtypes = [ctypes.c_char_p, ctypes.c_char_p, cls.__PROGRESS_CALLBACK,
                                                   ctypes.py_object]
            ...
            cls.__lib.Amcam_StartPullModeWithCallback.argtypes = [ctypes.c_void_p, cls.__EVENT_CALLBACK,
                                                                  ctypes.py_object]
            cls.__lib.Amcam_PullImageV2.restype = ctypes.c_int
            cls.__lib.Amcam_PullImageV2.errcheck = cls.__errcheck
            cls.__lib.Amcam_PullImageV2.argtypes = [ctypes.c_void_p, ctypes.c_char_p, ctypes.c_int,
                                                    ctypes.POINTER(cls.__FrameInfoV2)]
            cls.__lib.Amcam_PullStillImageV2.restype = ctypes.c_int
            cls.__lib.Amcam_PullStillImageV2.errcheck = cls.__errcheck
            cls.__lib.Amcam_PullStillImageV2.argtypes = [ctypes.c_void_p, ctypes.c_char_p, ctypes.c_int,
                                                         ctypes.POINTER(cls.__FrameInfoV2)]
            ...
            cls.__lib.Amcam_PullImageWithRowPitchV2.argtypes = [ctypes.c_void_p, ctypes.c_char_p, ctypes.c_int,
                                                                ctypes.c_int, ctypes.POINTER(cls.__FrameInfoV2)]
            ...
            cls.__lib.Amcam_PullStillImageWithRowPitchV2.argtypes = [ctypes.c_void_p, ctypes.c_char_p, ctypes.c_int,
                                                                     ctypes.c_int, ctypes.POINTER(cls.__FrameInfoV2)]
            ...
            cls.__lib.Amcam_get_Size.argtypes = [ctypes.c_void_p, ctypes.POINTER(ctypes.c_int),
            ...
            cls.__lib.Amcam_get_FinalSize.argtypes = [ctypes.c_void_p, ctypes.POINTER(ctypes.c_int),
                                                      ctypes.POINTER(ctypes.c_int)]
            ...
            cls.__lib.Amcam_get_Resolution.argtypes = [ctypes.c_void_p, ctypes.c_uint, ctypes.POINTER(ctypes.c_int),
                                                       ctypes.POINTER(ctypes.c_int)];
            cls.__lib.Amcam_get_ResolutionRatio.restype = ctypes.c_int
            cls.__lib.Amcam_get_ResolutionRatio.errcheck = cls.__errcheck
            cls.__lib.Amcam_get_ResolutionRatio.argtypes = [ctypes.c_void_p, ctypes.c_uint,
            ...
            cls.__lib.Amcam_get_RawFormat.argtypes = [ctypes.c_void_p, ctypes.POINTER(ctypes.c_uint),
            ...
            cls.__lib.Amcam_get_MaxAutoExpoTimeAGain.argtypes = [ctypes.c_void_p, ctypes.POINTER(ctypes.c_uint),
            ...
            cls.__lib.Amcam_get_MinAutoExpoTimeAGain.argtypes = [ctypes.c_void_p, ctypes.POINTER(ctypes.c_uint),
                                                                 ctypes.POINTER(ctypes.c_ushort)]
            ...
            cls.__lib.Amcam_get_ExpTimeRange.argtypes = [ctypes.c_void_p, ctypes.POINTER(ctypes.c_uint),
            ...
            cls.__lib.Amcam_get_ExpoAGainRange.argtypes = [ctypes.c_void_p, ctypes.POINTER(ctypes.c_ushort),
                                                           ctypes.POINTER(ctypes.c_ushort),
                                                           ctypes.POINTER(ctypes.c_ushort)]
            ...
            cls.__lib.Amcam_get_TempTint.argtypes = [ctypes.c_void_p, ctypes.POINTER(ctypes.c_int),
                                                     ctypes.POINTER(ctypes.c_int)]
            ...
            cls.__lib.Amcam_get_StillResolution.argtypes = [ctypes.c_void_p, ctypes.c_uint,
                                                            ctypes.POINTER(ctypes.c_int), ctypes.POINTER(ctypes.c_int)]
            ...
            cls.__lib.Amcam_get_PixelSize.argtypes = [ctypes.c_void_p, ctypes.c_int, ctypes.POINTER(ctypes.c_float),
            ...
            cls.__lib.Amcam_put_LevelRangeV2.argtypes = [ctypes.c_void_p, ctypes.c_ushort, ctypes.POINTER(cls.__RECT),
                                                         (ctypes.c_ushort * 4), (ctypes.c_ushort * 4)]
            cls.__lib.Amcam_get_LevelRangeV2.restype = ctypes.c_int
            cls.__lib.Amcam_get_LevelRangeV2.errcheck = cls.__errcheck
            cls.__lib.Amcam_get_LevelRangeV2.argtypes = [ctypes.c_void_p, ctypes.POINTER(ctypes.c_ushort),
                                                         ctypes.POINTER(cls.__RECT), (ctypes.c_ushort * 4),
                                                         (ctypes.c_ushort * 4)]
            ...
            cls.__lib.Amcam_put_LEDState.argtypes = [ctypes.c_void_p, ctypes.c_ushort, ctypes.c_ushort, ctypes.c_ushort,
                                                     ctypes.c_ushort]
            ...
            cls.__lib.Amcam_put_Roi.argtypes = [ctypes.c_void_p, ctypes.c_uint, ctypes.c_uint, ctypes.c_uint,
                                                ctypes.c_uint]
            cls.__lib.Amcam_get_Roi.restype = ctypes.c_int
            cls.__lib.Amcam_get_Roi.errcheck = cls.__errcheck
            cls.__lib.Amcam_get_Roi.argtypes = [ctypes.c_void_p, ctypes.POINTER(ctypes.c_uint),
                                                ctypes.POINTER(ctypes.c_uint), ctypes.POINTER(ctypes.c_uint),
                                                ctypes.POINTER(ctypes.c_uint)]
            ...
            cls.__lib.Amcam_IoControl.argtypes = [ctypes.c_void_p, ctypes.c_uint, ctypes.c_uint, ctypes.c_int,
                                                  ctypes.POINTER(ctypes.c_int)]
            ...
            cls.__lib.Amcam_put_Linear.argtypes = [ctypes.c_void_p, ctypes.POINTER(ctypes.c_ubyte),
                                                   ctypes.POINTER(ctypes.c_ushort)]
            cls.__lib.Amcam_put_Curve.restype = ctypes.c_int
            cls.__lib.Amcam_put_Curve.errcheck = cls.__errcheck
            cls.__lib.Amcam_put_Curve.argtypes = [ctypes.c_void_p, ctypes.POINTER(ctypes.c_ubyte),
                                                  ctypes.POINTER(ctypes.c_ushort)]
            ...
            cls.__lib.Amcam_get_FrameRate.argtypes = [ctypes.c_void_p, ctypes.POINTER(ctypes.c_uint),
                                                      ctypes.POINTER(ctypes.c_uint), ctypes.POINTER(ctypes.c_uint)]
            if sys.platform != 'win32':
