...
ERRORS = {
    ...
    303: "PI Stage: Axis not within controller operation.",
    304: "PI Stage: Attempting to move an inactive stage.",
    305: "PI Stage: Attempting to move stage beyond its limits.",
    404: "HW: UNKNOWN",
